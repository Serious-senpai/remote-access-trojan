...
const _BL_IMG_ALLOCATE_IMAGE_BUFFER: &[[u8; 49]] = &[
    ...
    [
        0xCC, // 1 byte before (int)
        0x48, 0x89, 0x5C, 0x24, 0x18, 0x55, 0x56, 0x57, // 8 bytes
        0x41, 0x54, 0x41, 0x55, 0x41, 0x56, 0x41, 0x57, // 8 bytes
        0x48, 0x8B, 0xEC, 0x48, 0x83, 0xEC, 0x50, 0x4C, // 8 bytes
        0x8B, 0x39, 0x4C, 0x8D, 0x62, 0xFF, 0x48, 0x83, // 8 bytes
        0x21, 0x00, 0x4C, 0x8B, 0xE9, 0x44, 0x8B, 0x75, // 8 bytes
        0x68, 0xB9, 0x00, 0x00, 0x01, 0x00, 0x41, 0x8B, // 8 bytes
    ],
    [
        0xCC, // 1 byte before (int)
        0x48, 0x89, 0x5C, 0x24, 0x18, 0x55, 0x56, 0x57, // 8 bytes
        0x41, 0x54, 0x41, 0x55, 0x41, 0x56, 0x41, 0x57, // 8 bytes
        0x48, 0x8B, 0xEC, 0x48, 0x83, 0xEC, 0x50, 0x48, // 8 bytes
        0x83, 0x65, 0x40, 0x00, 0x41, 0x8B, 0xF0, 0x44, // 8 bytes
        0x8B, 0x05, 0xB6, 0x3A, 0x1A, 0x00, 0x41, 0x8B, // 8 bytes
        0xF9, 0x4C, 0x8B, 0xFA, 0x4C, 0x8B, 0xE1, 0x45, // 8 bytes
    ],
];

const _OSL_FWP_KERNEL_SETUP_PHASE1: &[[u8; 49]] = &[
    // Windows 10
    [
        0xCC, // 1 byte before (int)
        ...
        0xEC, 0xB8, 0x00, 0x00, 0x00, 0x48, 0x8B, 0xF1, // 8 bytes
        0x33, 0xFF, 0x48, 0x8D, 0x4D, 0x6F, 0x48, 0x89, // 8 bytes
        0x7D, 0x7F, 0x44, 0x8B, 0xEF, 0xE8, 0x36, 0x82, // 8 bytes
    ],
    // Windows 11
    [
        0xCC, // 1 byte before (int)
        ...
        0x57, 0x41, 0x54, 0x41, 0x55, 0x41, 0x56, 0x41, // 8 bytes
        0x57, 0x48, 0x8D, 0x6C, 0x24, 0xE1, 0x48, 0x81, // 8 bytes
        0xEC, 0xA8, 0x00, 0x00, 0x00, 0x45, 0x33, 0xE4, // 8 bytes
        0x48, 0x8B, 0xF9, 0x48, 0x8D, 0x4D, 0x77, 0x4C, // 8 bytes
        0x89, 0x65, 0xBF, 0x44, 0x89, 0x65, 0x6F, 0x4C, // 8 bytes
    ],
    [
        0xCC, // 1 byte before (int)
        0x48, 0x89, 0x4C, 0x24, 0x08, 0x55, 0x53, 0x56, // 8 bytes
        0x57, 0x41, 0x54, 0x41, 0x55, 0x41, 0x56, 0x41, // 8 bytes
        0x57, 0x48, 0x8D, 0x6C, 0x24, 0xE1, 0x48, 0x81, // 8 bytes
        0xEC, 0x98, 0x00, 0x00, 0x00, 0x45, 0x33, 0xED, // 8 bytes
        0x48, 0x8D, 0x55, 0x77, 0x48, 0x8B, 0xF9, 0x4C, // 8 bytes
        0x89, 0x6D, 0xBF, 0x44, 0x89, 0x6D, 0x6F, 0x4C, // 8 bytes
    ],
];
